...
<body>
  <div class="wrapper">
    ...
    <main class="_container infoblock__container">
      <nav class="main__nav">
        <p class="main__nav-title">Содержание</p>
        <ul class="main__nav-list">
          <li class="main__nav-item">
            <a class="main__nav-link-title" href="#block1">Блок «Что тут происходит?»</a>
            <ol class="main__nav-ollist">
              <li class="main__nav-olitem"><a class="main__nav-link" href="#block1-q1">Кто такой самозанятый?</a></li>
              <li class="main__nav-olitem"><a class="main__nav-link" href="#block1-q2">Зачем получать статус самозанятого?</a></li>
              <li class="main__nav-olitem"><a class="main__nav-link" href="#block1-q3">Кто может получить статус самозанятого?</a></li>
              <li class="main__nav-olitem"><a class="main__nav-link" href="#block1-q4">Как получить статус самозанятого?</a></li>
            </ol>
          </li>
          <li class="main__nav-item">
            <a class="main__nav-link-title" href="#block2">Блок «Финансы»</a>
            <ol class="main__nav-ollist">
              <li class="main__nav-olitem"><a class="main__nav-link" href="#block2-q1">Как платить налог?</a></li>
              <li class="main__nav-olitem"><a class="main__nav-link" href="#block2-q2">Надо ли платить страховые взносы?</a></li>
              <li class="main__nav-olitem"><a class="main__nav-link" href="#block2-q3">Нужно ли самозанятому заводить специальный счет в банке?</a></li>
              <li class="main__nav-olitem"><a class="main__nav-link" href="#block2-q4">Как индивидуальному предпринимателю перерегистрироваться в самозанятого?</a></li>
              <li class="main__nav-olitem"><a class="main__nav-link" href="#block2-q5">Что будет, если мой профессиональный доход превысит 2,4 млн рублей за год?</a></li>
              <li class="main__nav-olitem"><a class="main__nav-link" href="#block2-q6">Есть ли какие-то налоговые льготы для самозанятых?</a></li>
              <li class="main__nav-olitem"><a class="main__nav-link" href="#block2-q7">Как получить официальную справку о своем доходе?</a></li>
              <li class="main__nav-olitem"><a class="main__nav-link" href="#block2-q8">Можно ли отказаться от статуса самозанятого?</a></li>
            </ol>
          </li>
        </ul>
      </nav>
      <h1 id="block1" class="main__block">Блок «Что тут происходит?»</h1>
      ...
      <div class="main__info"><img src="../images/infoblock-pic1.svg" alt="" class="main__img"></div>
      <h2 id="block1-q1" class="main__title">Кто такой самозанятый?</h2>
      <p class="main__text">Согласно <a href="http://www.consultant.ru/document/cons_doc_LAW_311977/512cf86a56df0bdea9fb5f14bba79e01a90ed7a5/" class="main__text-link">закону</a>
      ...
      <h2 id="block1-q2" class="main__title">Зачем получать статус самозанятого?</h2>
      <div class="main__info"><img src="../images/infoblock-pic2.svg" alt="" class="main__img"></div>
      ...
      <h2 id="block1-q3" class="main__title">Кто может получить статус самозанятого?</h2>
      ...
      <h2 id="block1-q4" class="main__title">Как получить статус самозанятого?</h2>
      ...
      <h1 id="block2" class="main__block">Блок «Финансы»</h1>
      <h2 id="block2-q1" class="main__title">Как платить налог?</h2>
      <div class="main__info"><img src="../images/infoblock-pic3.svg" alt="" class="main__img"></div>
      ...
      <h2 id="block2-q2" class="main__title">Надо ли платить страховые взносы?</h2>
      ...
      <h2 id="block2-q3" class="main__title">Нужно ли самозанятому заводить специальный счет в банке?</h2>
      ...
      <h2 id="block2-q4" class="main__title">Как индивидуальному предпринимателю перерегистрироваться в самозанятого?</h2>
      ...
      <div class="main__info"><img src="../images/infoblock-pic4.svg" alt="" class="main__img"></div>
      <h2 id="block2-q5" class="main__title">Что будет, если мой профессиональный доход превысит 2,4 млн рублей за год?</h2>
      ...
      <h2 id="block2-q6" class="main__title">Есть ли какие-то налоговые льготы для самозанятых?</h2>
      ...
      <h2 id="block2-q7" class="main__title">Как получить официальную справку о своем доходе?</h2>
      ...
      <h2 id="block2-q8" class="main__title">Можно ли отказаться от статуса самозанятого?</h2>
